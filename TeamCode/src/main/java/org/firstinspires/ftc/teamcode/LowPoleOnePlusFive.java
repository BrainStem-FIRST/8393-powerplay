...
public class LowPoleOnePlusFive extends LinearOpMode {
    ...
    public LowPoleOnePlusFive(AutoOrientation side) {
        this.side = side;
        switch (side) {
            case LEFT:
                initialTangent = -80;
