 ...
 */
@Config
public class SampleMecanumDriveNew extends MecanumDrive {
    ...
    public static double LATERAL_MULTIPLIER = 1.57;
    ...
    public SampleMecanumDriveNew(HardwareMap hardwareMap) {
        super(kV, kA, kStatic, TRACK_WIDTH, TRACK_WIDTH, LATERAL_MULTIPLIER);

        follower = new HolonomicPIDVAFollower(TRANSLATIONAL_PID, TRANSLATIONAL_PID, HEADING_PID,
                new Pose2d(0.25, 0.25, Math.toRadians(1.0)), 0.3);
        ...
        rightRear = hardwareMap.get(DcMotorEx.class, "BRandOdo");
        ...
        //setLocalizer(new TwoWheelTrackingLocalizer(hardwareMap, this)); //uncomment this when switching back
