...
public class PoleFakeTroubleAuto extends LinearOpMode {
    ...
    public PoleFakeTroubleAuto(AutoOrientation side) {
        this.side = side;
        switch (side) {
            case RIGHT:
                LEFTSIDE = false;
                initialApproach = new Pose2d(initialApproach.getX() , -initialApproach.getY(), Math.toRadians(180));
                initialTangent = 80;
    ...
    private TrajectorySequence initializeTrajectories(AutoBrainSTEMRobot robot, SampleMecanumDrive drive) {
        ...
        TrajectorySequence deliverPreload = drive.trajectorySequenceBuilder(startPosition)
                ...
                .UNSTABLE_addTemporalMarkerOffset(0.99, () -> {
