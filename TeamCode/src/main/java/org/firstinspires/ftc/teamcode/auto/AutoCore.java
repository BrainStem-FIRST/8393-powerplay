...
//                signalConeKnockout = new Pose2d(signalConeKnockout.getX(), -signalConeKnockout.getY(), Math.toRadians(180));
    ...
    public void runOpMode() throws InterruptedException {
        ...
        TrajectorySequence deliverPreload = drive.trajectorySequenceBuilder(startPosition)
                ...
                .UNSTABLE_addTemporalMarkerOffset(0, () -> { stateMap.put(robot.arm.SYSTEM_NAME, robot.arm.AUTO_EXTENSION_COLLECT); })
                .UNSTABLE_addTemporalMarkerOffset(0.5, () -> { stateMap.put(robot.lift.LIFT_SYSTEM_NAME, robot.lift.STACK_5); })
                .UNSTABLE_addTemporalMarkerOffset(1.0, () -> { robot.grabber.close(); })
                .UNSTABLE_addTemporalMarkerOffset(1.5, () -> { stateMap.put(robot.lift.LIFT_SYSTEM_NAME, robot.lift.LIFT_POLE_LOW); })
                .waitSeconds(2.5)

                .UNSTABLE_addTemporalMarkerOffset(0, () -> { stateMap.put(robot.turret.SYSTEM_NAME, turretDeliveryPosition);})
                .UNSTABLE_addTemporalMarkerOffset(0.1, () -> { stateMap.put(robot.arm.SYSTEM_NAME, robot.arm.AUTO_EXTENSION_DEPOSIT_TILTED); })
                .UNSTABLE_addTemporalMarkerOffset(0.6, () -> { stateMap.put(constants.CONE_CYCLE, constants.STATE_IN_PROGRESS); })
                .UNSTABLE_addTemporalMarkerOffset(1.0, () -> { stateMap.put(robot.lift.LIFT_SYSTEM_NAME, robot.lift.LIFT_POLE_LOW); })
                .UNSTABLE_addTemporalMarkerOffset(1.0, () -> { resetLift(); })
                .waitSeconds(1.25)

                .UNSTABLE_addTemporalMarkerOffset(0, () -> { stateMap.put(robot.turret.SYSTEM_NAME, turretPickupPosition); })
                .UNSTABLE_addTemporalMarkerOffset(0, () -> { stateMap.put(robot.arm.SYSTEM_NAME, robot.arm.AUTO_EXTENSION_COLLECT); })
                .UNSTABLE_addTemporalMarkerOffset(0.5, () -> { stateMap.put(robot.lift.LIFT_SYSTEM_NAME, robot.lift.STACK_4); })
                .UNSTABLE_addTemporalMarkerOffset(1.0, () -> { robot.grabber.close(); })
                .UNSTABLE_addTemporalMarkerOffset(1.5, () -> { stateMap.put(robot.lift.LIFT_SYSTEM_NAME, robot.lift.LIFT_POLE_LOW); })
                .waitSeconds(2.5)
                ...
                .UNSTABLE_addTemporalMarkerOffset(0, () -> { stateMap.put(robot.turret.SYSTEM_NAME, turretPickupPosition); })
                .UNSTABLE_addTemporalMarkerOffset(0, () -> { stateMap.put(robot.arm.SYSTEM_NAME, robot.arm.AUTO_EXTENSION_COLLECT); })
                .UNSTABLE_addTemporalMarkerOffset(0.5, () -> { stateMap.put(robot.lift.LIFT_SYSTEM_NAME, robot.lift.STACK_3); })
                .UNSTABLE_addTemporalMarkerOffset(1.25, () -> { robot.grabber.close(); })
                ...
                .UNSTABLE_addTemporalMarkerOffset(0, () -> { stateMap.put(robot.turret.SYSTEM_NAME, turretPickupPosition); })
                .UNSTABLE_addTemporalMarkerOffset(0, () -> { stateMap.put(robot.arm.SYSTEM_NAME, robot.arm.AUTO_EXTENSION_COLLECT); })
                .UNSTABLE_addTemporalMarkerOffset(0.5, () -> { stateMap.put(robot.lift.LIFT_SYSTEM_NAME, robot.lift.STACK_2); })
                .UNSTABLE_addTemporalMarkerOffset(1.25, () -> { robot.grabber.close(); })
                .UNSTABLE_addTemporalMarkerOffset(1.75, () -> { stateMap.put(robot.lift.LIFT_SYSTEM_NAME, robot.lift.LIFT_POLE_LOW); })
                .waitSeconds(2.75)
                ...
                .UNSTABLE_addTemporalMarkerOffset(0, () -> { stateMap.put(robot.turret.SYSTEM_NAME, turretPickupPosition); })
                .UNSTABLE_addTemporalMarkerOffset(0, () -> { stateMap.put(robot.arm.SYSTEM_NAME, robot.arm.AUTO_EXTENSION_COLLECT); })
                .UNSTABLE_addTemporalMarkerOffset(0.5, () -> { stateMap.put(robot.lift.LIFT_SYSTEM_NAME, robot.lift.STACK_1); })
                .UNSTABLE_addTemporalMarkerOffset(1.5, () -> { robot.grabber.close(); })
                .UNSTABLE_addTemporalMarkerOffset(2.0, () -> { stateMap.put(robot.lift.LIFT_SYSTEM_NAME, robot.lift.LIFT_POLE_LOW); })
                .waitSeconds(3.0)
