...
import org.firstinspires.ftc.teamcode.drive.SampleMecanumDriveUnContested;
...
public class OnlyUncontestedHighPoleOnePlusFive extends LinearOpMode {
    ...
    private Pose2d highPoleDepositingPositionLeft = new Pose2d(-22.50, -13, Math.toRadians(180));
    private Pose2d uncontestedHighPolePosition = new Pose2d(1.00, -12.00, Math.toRadians(180));
    ...
    private Vector2d collectConesPositionPreload = new Vector2d(-57.35, -12); //-55.5
    private Vector2d collectConesPositionApproach = new Vector2d(-50.75, -12); //-55.5
    ...
    private String uncontestedTurretPosition;
    ...
    private String uncontestedExtensionSide;
    ...
    public OnlyUncontestedHighPoleOnePlusFive(AutoOrientation side) {
        this.side = side;
        switch (side) {
            case RIGHT:
                LEFTSIDE = false;
    ...
    public void runOpMode() throws InterruptedException {
        ...
        // Hardwhare ///////////////////////////////////////////////////////////////////
        SampleMecanumDriveUnContested drive = new SampleMecanumDriveUnContested(this.hardwareMap);
    ...
    private TrajectorySequence initializeTrajectories(AutoBrainSTEMRobot robot, SampleMecanumDriveUnContested drive) {
        ...
        TrajectorySequence deliverPreload = drive.trajectorySequenceBuilder(startPosition)
                ...
                .splineToSplineHeading(uncontestedHighPolePosition, Math.toRadians(highPoleDepositingPositionTangent),
                        SampleMecanumDrive.getVelocityConstraint(53, DriveConstants.MAX_ANG_VEL, DriveConstants.TRACK_WIDTH),
                        SampleMecanumDrive.getAccelerationConstraint(40))
                ...
                .setReversed(true)
                .splineToConstantHeading(new Vector2d(uncontestedHighPolePosition.getX(), highPoleDepositingPosition.getY()),
                        Math.toRadians(highPoleDepositingPositionTangent),
                        SampleMecanumDrive.getVelocityConstraint(50, DriveConstants.MAX_ANG_VEL, DriveConstants.TRACK_WIDTH),
                        SampleMecanumDrive.getAccelerationConstraint(60))
                .UNSTABLE_addTemporalMarkerOffset(-0.75, () -> {
                ...
                .setReversed(false)
                .splineToConstantHeading(collectConesPositionApproach, Math.toRadians(180 - highPoleDepositingPositionTangent),
                        SampleMecanumDrive.getVelocityConstraint(58, DriveConstants.MAX_ANG_VEL, DriveConstants.TRACK_WIDTH),
                        SampleMecanumDrive.getAccelerationConstraint(53))
                .UNSTABLE_addTemporalMarkerOffset(-1.2, () -> {
                    stateMap.put(robot.poleAligner.SYSTEM_NAME, robot.poleAligner.UP);
                })
