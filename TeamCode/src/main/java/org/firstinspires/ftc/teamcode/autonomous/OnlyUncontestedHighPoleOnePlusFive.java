...
// Needs to be faster in all parts
...
public class OnlyUncontestedHighPoleOnePlusFive extends LinearOpMode {
    ...
    private Pose2d uncontestedHighPolePosition = new Pose2d(1.250, -12.00, Math.toRadians(180));
...
//                    stateMap.put(robot.arm.SYSTEM_NAME, robot.arm.I_HATE_PHYSICS);
