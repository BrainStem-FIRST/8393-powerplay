...
@Config
@Disabled
public class SampleMecanumDriveUnContested extends MecanumDrive {
    ...
    public SampleMecanumDriveUnContested(HardwareMap hardwareMap) {
        super(kV, kA, kStatic, TRACK_WIDTH, TRACK_WIDTH, LATERAL_MULTIPLIER);

        follower = new HolonomicPIDVAFollower(TRANSLATIONAL_PID, TRANSLATIONAL_PID, HEADING_PID,
                new Pose2d(0.25, 0.25, Math.toRadians(1.0)), 0.35);
